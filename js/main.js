...
swiper__WEBPACK_IMPORTED_MODULE_9__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_9__["Navigation"], swiper__WEBPACK_IMPORTED_MODULE_9__["Pagination"], swiper__WEBPACK_IMPORTED_MODULE_9__["Autoplay"], swiper__WEBPACK_IMPORTED_MODULE_9__["EffectFade"]]);
_fancyapps_ui__WEBPACK_IMPORTED_MODULE_10__["Fancybox"].bind("[data-fancybox-plyr]", {
  mainClass: 'fullVid',
  on: {
    ...
    closing: function closing(fancybox, slide) {
      var currentVideo = swiper3.slides[swiper3.activeIndex].children[0];
      currentVideo.play();
    }
  }
});
var swiper1 = new swiper__WEBPACK_IMPORTED_MODULE_9__["default"](".slider-hero", {
  effect: "fade",
  loop: true,
  autoplay: {
    delay: 5000,
...
var swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_9__["default"](".slider-prod", {
  loop: true,
  pagination: {
  ...
  on: {
    slideChange: function slideChange(swiper) {
      var dynamicText = document.getElementById("js-dynamic-text");
      var dynamicSubtext = document.getElementById("js-dynamic-subtext");
...
var swiper3 = new swiper__WEBPACK_IMPORTED_MODULE_9__["default"]('.slider-demonstration', {
  effect: "fade",
  loop: false,
  pagination: {
  ...
  on: {
    init: function init() {// console.log("swiper init");
    }
  }
});
var sliderVideos = $(".slider-demonstration .swiper-slide video");
...
swiper3.on('slideChange', function () {
  var currentVideo = swiper3.slides[swiper3.activeIndex].children[0];
  var prevVideo = swiper3.slides[swiper3.previousIndex].children[0];
  sliderVideos.each(function (index) {
    this.pause();
    this.currentTime = 0;
  });
...
var swiper4 = new swiper__WEBPACK_IMPORTED_MODULE_9__["default"](".slider-gallery", {
  effect: "fade",
  loop: true,
  // height: 800,
  // autoplay: {
...
window.onload = function () {
  var ShowScroll = function ShowScroll(btnScrollTop) {
    window.addEventListener('scroll', function () {
      var shouldBeVisible = window.pageYOffset > 1700;
